...
class TypeVehiclePolicy
{
    ...
    {
        return $user->hasPermissionTo('list typevehicles');
    }
    ...
    {
        return $user->hasPermissionTo('view typevehicles');
    }
    ...
    {
        return $user->hasPermissionTo('create typevehicles');
    }
    ...
    {
        return $user->hasPermissionTo('update typevehicles');
    }
    ...
    {
        return $user->hasPermissionTo('delete typevehicles');
    }
