...
class ChargerLocationPolicy
{
    ...
    {
        return $user->hasPermissionTo('list chargerlocations');
    }
    ...
    {
        return $user->hasPermissionTo('view chargerlocations');
    }
    ...
    {
        return $user->hasPermissionTo('create chargerlocations');
    }
    ...
    {
        return $user->hasPermissionTo('update chargerlocations');
    }
    ...
    {
        return $user->hasPermissionTo('delete chargerlocations');
    }
