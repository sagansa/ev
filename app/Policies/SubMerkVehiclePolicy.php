...
class SubMerkVehiclePolicy
{
    ...
    {
        return $user->hasPermissionTo('list submerkvehicles');
    }
    ...
    {
        return $user->hasPermissionTo('view submerkvehicles');
    }
    ...
    {
        return $user->hasPermissionTo('create submerkvehicles');
    }
    ...
    {
        return $user->hasPermissionTo('update submerkvehicles');
    }
    ...
    {
        return $user->hasPermissionTo('delete submerkvehicles');
    }
