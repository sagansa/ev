...
class StateOfHealthPolicy
{
    ...
    {
        return $user->hasPermissionTo('list stateofhealths');
    }
    ...
    {
        return $user->hasPermissionTo('view stateofhealths');
    }
    ...
    {
        return $user->hasPermissionTo('create stateofhealths');
    }
    ...
    {
        return $user->hasPermissionTo('update stateofhealths');
    }
    ...
    {
        return $user->hasPermissionTo('delete stateofhealths');
    }
