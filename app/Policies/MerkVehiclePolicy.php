...
class MerkVehiclePolicy
{
    ...
    {
        return $user->hasPermissionTo('list merkvehicles');
    }
    ...
    {
        return $user->hasPermissionTo('view merkvehicles');
    }
    ...
    {
        return $user->hasPermissionTo('create merkvehicles');
    }
    ...
    {
        return $user->hasPermissionTo('update merkvehicles');
    }
    ...
    {
        return $user->hasPermissionTo('delete merkvehicles');
    }
