...
class ChargerLocationChargesDetail extends Component
{
    use WithPagination;
    use WithFileUploads;
    ...
    protected $rules = [
        ...
        'charge.charger_id' => ['required', 'exists:chargers,id'],
    ...
    public function mount(ChargerLocation $chargerLocation): void
    {
        ...
        $this->chargersForSelect = Charger::pluck('power', 'id');
    ...
    {
        $this->editing = false;
        $this->modalTitle = trans('crud.charger_location_charges.new_title');
        $this->resetChargeData();
    ...
    {
        $this->editing = true;
        $this->modalTitle = trans('crud.charger_location_charges.edit_title');
        $this->charge = $charge;
    ...
    public function save(): void
    {
        ...
        if (!$this->charge->charger_location_id) {
            $this->authorize('create', Charge::class);

            $this->charge->charger_location_id = $this->chargerLocation->id;
        } else {
    ...
    public function toggleFullSelection(): void
    {
        ...
        foreach ($this->chargerLocation->charges as $charge) {
    ...
    {
        return view('livewire.charger-location-charges-detail', [
            'charges' => $this->chargerLocation->charges()->paginate(20),
        ]);
    }
}
