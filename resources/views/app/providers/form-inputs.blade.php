@php $editing = isset($provider) @endphp
...
<div class="flex flex-wrap">
    <x-inputs.group class="w-full">
        <x-inputs.text
            name="name"
            label="Name"
            :value="old('name', ($editing ? $provider->name : ''))"
            maxlength="20"
            placeholder="Name"
            required
        ></x-inputs.text>
    ...
    <x-inputs.group class="w-full">
        <x-inputs.select name="status" label="Status">
            @php $selected = old('status', ($editing ? $provider->status : 'not verified')) @endphp
    ...
    <x-inputs.group class="w-full">
        <x-inputs.select name="user_id" label="User" required>
            @php $selected = old('user_id', ($editing ? $provider->user_id : '')) @endphp
