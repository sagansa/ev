<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.state_of_healths.index_title')
        </h2>
    </x-slot>
                ...
                <div class="block w-full overflow-auto scrolling-touch">
                    <table class="w-full max-w-full mb-4 bg-transparent">
                        ...
                        <tbody class="text-gray-600">
                            @forelse($stateOfHealths as $stateOfHealth)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-right">
                                    {{ $stateOfHealth->percentage ?? '-' }}
                                </td>
                                <td class="px-4 py-3 text-left">
                                    {{ $stateOfHealth->how_to_charge ?? '-' }}
                                </td>
                                <td class="px-4 py-3 text-left">
                                ...
                                >
                                    <div
                                        ...
                                        "
                                    >
                                        @can('update', $stateOfHealth)
                                        <a
                                            href="{{ route('state-of-healths.edit', $stateOfHealth) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $stateOfHealth)
                                        <a
                                            href="{{ route('state-of-healths.show', $stateOfHealth) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $stateOfHealth)
                                        <form
                                            action="{{ route('state-of-healths.destroy', $stateOfHealth) }}"
                                            method="POST"
