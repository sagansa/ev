<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.sub_merk_vehicles.index_title')
        </h2>
    </x-slot>
                ...
                <div class="block w-full overflow-auto scrolling-touch">
                    <table class="w-full max-w-full mb-4 bg-transparent">
                        ...
                        <tbody class="text-gray-600">
                            @forelse($subMerkVehicles as $subMerkVehicle)
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <a
                                            href="{{ route('sub-merk-vehicles.edit', $subMerkVehicle) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $subMerkVehicle)
                                        <a
                                            href="{{ route('sub-merk-vehicles.show', $subMerkVehicle) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $subMerkVehicle)
                                        <form
                                            action="{{ route('sub-merk-vehicles.destroy', $subMerkVehicle) }}"
                                            method="POST"
