        ...
        <div class="px-6 py-4">
            ...
            <div class="mt-5">
                <div>
                    ...
                    <x-inputs.group class="w-full">
                        <x-inputs.select
                            name="charge.charger_location_id"
                            label="Charger Location"
                            wire:model="charge.charger_location_id"
                        >
                            <option value="null" disabled>Please select the Charger Location</option>
                            @foreach($chargerLocationsForSelect as $value => $label)
                            <option value="{{ $value }}"  >{{ $label }}</option>
                            @endforeach
                        </x-inputs.select>
                    </x-inputs.group>
            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.charger_charges.inputs.image')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.charger_charges.inputs.vehicle_id')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.charger_charges.inputs.date')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.charger_charges.inputs.charger_location_id')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.charger_charges.inputs.km_now')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.charger_charges.inputs.km_before')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.charger_charges.inputs.battery_start_charging')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.charger_charges.inputs.battery_finish_charging')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.charger_charges.inputs.battery_finish_before')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.charger_charges.inputs.parking')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.charger_charges.inputs.kWh')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.charger_charges.inputs.PPJ')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.charger_charges.inputs.PPN')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.charger_charges.inputs.admin_cost')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.charger_charges.inputs.total_cost')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.charger_charges.inputs.user_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
