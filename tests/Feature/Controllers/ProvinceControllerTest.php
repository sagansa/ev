...
class ProvinceControllerTest extends TestCase
{
     ...
     * @test
     */
    public function it_displays_index_view_with_provinces(): void
    {
     ...
     * @test
     */
    public function it_displays_create_view_for_province(): void
    {
     ...
     * @test
     */
    public function it_displays_show_view_for_province(): void
    {
     ...
     * @test
     */
    public function it_displays_edit_view_for_province(): void
    {
        $province = Province::factory()->create();
